...
const Header = ({ navbarBelow = true }) => {
  ...
  return (
    <div
      className='flex flex-col justify-center py-2 px-1.5 md:py-1 md:px-4 md:10 lg:px-20 xl:px-40'
      ...
      {navbarBelow && (
        <div className='flex items-center'>
          <img
            src={Logo}
            alt=''
            className='text-[#fffeff] h-[3rem] md:h-[6rem] mr-12 hidden md:block'
          />
